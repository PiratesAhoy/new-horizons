//#include "DIALOGS\PZGeorg Geheim_Dialog.h"
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			if (CheckQuestAttribute("GEORGGEHEIM", "thirsty"))
			{
			    PlaySound("VOICE\ENGLISH\Geheim.wav");
		...
		case "solved":
			...
			link.l1 = DLG_TEXT[7];
			link.l1.go = "exit";
			AddDialogExitQuest("GeorgGeheim_solved");
		break;
