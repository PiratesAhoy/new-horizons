//#include "DIALOGS\PZPrivate Pyle_Dialog.h"
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			if (CheckQuestAttribute("PRIVATEPYLE", "thirsty"))
			{
			    PlaySound("VOICE\ENGLISH\Pyle.wav");
		...
		case "solved":
			...
			link.l1 = DLG_TEXT[7];
			link.l1.go = "exit";
			AddDialogExitQuest("PrivatePyle_solved");
		break;
