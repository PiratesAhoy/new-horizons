//#include "DIALOGS\PZJungle Julia_Dialog.h"
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			if (CheckQuestAttribute("JUNGLEJULIA", "thirsty"))
			{
			    PlaySound("VOICE\ENGLISH\julia.wav");
		...
		case "solved":
			...
			link.l1 = DLG_TEXT[7];
			link.l1.go = "exit";
			AddDialogExitQuest("JungleJulia_solved");
		break;
