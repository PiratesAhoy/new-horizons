...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			if (!CheckAttribute(NPChar,"quest.meeting"))
//			if(NPChar.quest.meeting == "0")
			{
				...
				dialog.snd2 = "";
				dialog.snd3 = "";
				d.Text = RandPhrase(TimeGreeting() + DLG_TEXT[0], DLG_TEXT[1], DLG_TEXT[2], d, dialog.snd1, dialog.snd2, dialog.snd3);
//				d.Text = RandPhrase(TimeGreeting() + DLG_TEXT[0], DLG_TEXT[1], DLG_TEXT[2], &Dialog, dialog.snd1, dialog.snd2, dialog.snd3);
		...
		case "info":
				...
				dialog.snd2 = "";
				dialog.snd3 = "";
				d.Text = RandPhrase(DLG_TEXT[70] + GetMyFirstNames(PChar, false) + DLG_TEXT[71], DLG_TEXT[72], DLG_TEXT[73], &Dialog, "", "", "");
				Link.l1 = DLG_TEXT[74];
				Link.l1.go = "governor";
				Link.l2 = DLG_TEXT[75];
...
//				}
		...
		case "town":
			...
			dialog.snd2 = "";
			dialog.snd3 = "";
			d.Text = RandPhrase(DLG_TEXT[85] + GetMyFirstNames(PChar, false) + DLG_TEXT[86], DLG_TEXT[87], DLG_TEXT[88] + GetMyFirstNames(PChar, false) + DLG_TEXT[89], &Dialog, "", "", "");
			Link.l1 = DLG_TEXT[90];
...
//			Link.l2.go = "town_store";
		...
		case "colony":
			...
			dialog.snd2 = "";
			dialog.snd3 = "";
			d.Text = RandPhrase(DLG_TEXT[105] + GetMyFirstNames(PChar, false) + DLG_TEXT[106], DLG_TEXT[107], DLG_TEXT[108] + GetMyFirstNames(PChar, false) + DLG_TEXT[109], &Dialog, "", "", "");
			if(Rand(1)== 0)
			{
