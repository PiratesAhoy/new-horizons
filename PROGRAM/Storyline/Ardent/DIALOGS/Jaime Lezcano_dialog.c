...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "imperial_escort_explain2":
			dialog.text = GetMySimpleName(CharacterfromID("Javier Balboa")) + DLG_TEXT[19] + GetMyFullName(CharacterFromID("Imperial_envoy")) + DLG_TEXT[20] + GetMySimpleName(CharacterfromID("Javier Balboa")) + DLG_TEXT[21] + GetMyFullName(CharacterFromID("Emiliano de Guzmбn")) + DLG_TEXT[22];
		...
		case "imperial_escort_explain3":
			...
			link.l1 = DLG_TEXT[25] + GetMyFullName(CharacterFromID("Emiliano de Guzmбn")) + DLG_TEXT[26];
			link.l1.go = "imperial_escort_explain4";
		break;

		case "imperial_escort_explain4":
			dialog.text = DLG_TEXT[27] + GetMyFullName(CharacterFromID("Emiliano de Guzmбn")) + DLG_TEXT[28] + GetMyFullName(CharacterFromID("Imperial_envoy")) + DLG_TEXT[29];
			link.l1 = DLG_TEXT[30];
		...
		case "imperial_escort_negotiations_in_cave8":
			dialog.text = DLG_TEXT[59] + GetMyFullName(CharacterFromID("Emiliano de Guzmбn")) + ".";
			link.l1 = DLG_TEXT[60];
		...
		case "imperial_escort_negotations_outside_cave8":
			dialog.text = DLG_TEXT[84] + GetMyFullName(CharacterFromID("Emiliano de Guzmбn")) + DLG_TEXT[85];
			link.l1 = DLG_TEXT[86];
