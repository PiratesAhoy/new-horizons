...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "outside_cave_he_must_face_justice":
			...
			link.l1 = DLG_TEXT[23] + GetMyFullName(CharacterFromID("Emiliano de Guzmбn")) + DLG_TEXT[24];
		...
		case "inside_cave_kidnappers_mistake":
			dialog.text = DLG_TEXT[50] + GetMySimpleName(CharacterFromID("Emiliano de Guzmбn")) + DLG_TEXT[51];
			link.l1 = DLG_TEXT[52] + GetMySimpleName(CharacterFromID("Emiliano de Guzmбn")) + DLG_TEXT[53];
			link.l1.go = "exit";
		break;
		...
		case "santiago_on_to_townhall":
			dialog.text = DLG_TEXT[61] + GetMyFullName(CharacterFromID("Emiliano de Guzmбn")) + DLG_TEXT[62];
			link.l1 = DLG_TEXT[63];
			link.l1.go = "exit";
		break;
		...
		case "santiago_townhall_approach":
			...
			link.l1 = DLG_TEXT[65] + GetMyFullName(CharacterFromID("Emiliano de Guzmбn")) + DLG_TEXT[66];
...
//			else Preprocessor_Add("pronoun3", XI_ConvertString("her"));
			...
			dialog.text = DLG_TEXT[69] + GetRankName(CharacterFromID("Jusepe Guimaraes"), sti(Characters[GetCharacterIndex("Jusepe Guimaraes")].nation)) + DLG_TEXT[70] + GetMyLastName(PChar) + DLG_TEXT[71] + GetMyLastName(PChar) + DLG_TEXT[72] + GetMyFullName(CharacterFromID("Emiliano de Guzmбn")) + DLG_TEXT[73];
			link.l1 = "";
			link.l1.go = "exit";
		break;
...
//			else Preprocessor_Add("pronoun3", XI_ConvertString("her"));
			Preprocessor_Add("pronoun3", XI_ConvertString(GetMyPronounPossessive(PChar)));
			string finally = "";
			if(!LAi_IsDead(CharacterFromID("Emiliano de Guzmбn"))) finally = DLG_TEXT[77] + GetMyFullName(CharacterFromID("Emiliano de Guzmбn")) + DLG_TEXT[78];
		...
		case "guzman_dead_goto_havana":
			...
			link.l1 = DLG_TEXT[94] + GetMyFullName(CharacterFromID("Emiliano de Guzmбn")) + DLG_TEXT[95];
