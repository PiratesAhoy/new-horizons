...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			{
				link.l1 = GetRankName(NPChar, sti(NPChar.nation)) + DLG_TEXT[179] + GetMyFullName(CharacterFromID("Emiliano de Guzmбn")) + DLG_TEXT[180];
...
//				PChar.quest.finale_assign_galleons = "true";
		...
		case "imperial_escort_whodunnit":
			...
			link.l1 = DLG_TEXT[90] + GetRankName(NPChar, sti(NPChar.nation)) + DLG_TEXT[91] + GetMyFullName(CharacterFromID("Javier Balboa")) + DLG_TEXT[92] + GetMyFullName(CharacterFromID("Emiliano de Guzmбn")) + DLG_TEXT[93];
		...
		case "imperial_escort_that_seems_fair":
			...
			{
				link.l1 = GetRankName(NPChar, sti(NPChar.nation)) + DLG_TEXT[110] + GetMyFullName(CharacterFromID("Emiliano de Guzmбn")) + DLG_TEXT[111];
