...
"Exit",
"Could you tell us if the caravel in the port belongs to Charles Baxter?",
"You are not from this town, are you? Know this... we don't like curious people, here!",
"Is it so hard to answer my question?",
"I repair ships, not idle chatter. So, if you don't want your ship repaired, get out or I call the guards.",
"Thanks for nothing, if I had more time I would teach you some manners!",
