//#include "DIALOGS\Roxanne at Falaisedefleur_dialog.h"
...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "begin_7":
			...
			link.l1 = DLG_TEXT[19];
			link.l1.go = "exit_2";
			npchar.location="Falaise_de_fleur_location_03";
			npchar.location.group = "goto";
			npchar.location.locator = "locator21";
		...
		case "partage":
			...
			if (makeint(PChar.money) >= (makeint(Npchar.rank)*5000))
			{
				...
				npchar.location = "Falaise_de_fleur_tavern";
				npchar.location.group = "goto";
