//#include "DIALOGS\Morgan at Redmond_dialog.h"
...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "begin_7":
			...
			link.l1 = DLG_TEXT[19];
			link.l1.go = "exit_2";
			npchar.location="Redmond_town_01";
			npchar.location.group = "goto";
			npchar.location.locator = "goto10";
		...
		case "partage":
			...
			if (makeint(PChar.money) >= (makeint(Npchar.rank)*5000))
			{
				...
				npchar.location = "Redmond_Tavern";
				npchar.location.group = "goto";
				npchar.location.locator = "goto16";
