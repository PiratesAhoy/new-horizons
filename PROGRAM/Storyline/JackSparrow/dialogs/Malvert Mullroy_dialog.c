//#include "DIALOGS\Malvert Mullroy_dialog.h"
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "speak2":
			...
			link.l1 = DLG_TEXT[9];
			link.l1.go = "speak2add";
		break;

		case "speak2add":
			dialog.text = DLG_TEXT[4];
			link.l1 = DLG_TEXT[5];
			link.l1.go = "exitMullroy1";
		break;

		case "speak3":
			dialog.text = DLG_TEXT[6];
			link.l1 = DLG_TEXT[7];
			link.l1.go = "exitMullroy2";
		break;
		...
		case "exitMullroy1":
			AddDialogExitQuest("what_are_you_up_to");
			DialogExit();
			Diag.CurrentNode = "First time";
		break;
		case "exitMullroy2":
			AddDialogExitQuest("get_ready_for_the_splash");
			DialogExit();
			Diag.CurrentNode = "First time";
		break;

		case "exitMullroy3":
			AddDialogExitQuest("Dive_time_prep");
			DialogExit();
			Diag.CurrentNode = "First time";
		break;
