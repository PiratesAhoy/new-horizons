void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			if (CheckQuestAttribute("Jacks_early_days", "First_time_Redmond"))
			{
				d.Text = DLG_TEXT[0];
...
// NK -->
		...
		case "NGservice":
			...
			Link.l1.go = "exit"
			ReceiveLetterOfMarque(iNation); // KK
...
// NK <--
		...
		case "Story_Oxbay_Captured_15":
			...
			Link.l1 = DLG_TEXT[80];
			Link.l1.go = "exit";
			pchar.quest.Beckett_talk = "going_for_the_spy";
		...
		case "Story_1stTaskComplete_3":
			pchar.quest.Beckett_talk = "try_to_sink_French_ship";
			d.Text = DLG_TEXT[88];
			Link.l1 = DLG_TEXT[89];
		...
		case "Story_2ndTask_9":
			...
			Link.l1.go = "Exit";
			pchar.quest.Beckett_talk = "ship_been_sunk";
			if (AUTO_SKILL_SYSTEM)
			{
...
//!!!!__________BY ARTEM!!!!!!!!!!!!!!
		...
		case "escape_from_prison_node":
			...
			Link.l1.go = "escape_from_prison_node_2";
		break;
