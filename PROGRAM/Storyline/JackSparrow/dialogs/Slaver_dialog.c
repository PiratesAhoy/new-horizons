...
//			if (makeint(pchar.money) >= CalcEncOfficerPrice(NPChar))	// LDH - should probably use this instead - 16Apr09
		...
		case "exit_kill":
			dialogexit();
			AddDialogExitQuest("Kill_slaver");
		break;
		...
		case "smugglers_thanks_2":
			...
			SetCharacterRemovable(characterFromID("Nigel Blythe"), false);
		break;
		...
		case "exit_T1":
			...
			Pchar.quest.To_Ship_Slaver.win_condition.l1 = "location";
			Pchar.quest.To_Ship_Slaver.win_condition.l1.character = "Slaver";
			Pchar.quest.To_Ship_Slaver.win_condition.l1.location = "Douwesen_Shore_ship";
			Pchar.quest.To_Ship_Slaver.win_condition = "To_Ship_Slaver";
		...
		case "exit_T2":			
			...
			AddQuestRecord("Slaver", 5);
			AddDialogExitQuest("Jocard_Plantation");			
			LAi_SetOfficerType(characterFromID("Slaver"));
			DialogExit();
		break;
	}
