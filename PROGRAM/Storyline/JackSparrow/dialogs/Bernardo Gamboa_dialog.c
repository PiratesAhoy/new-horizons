...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			if (characters[getcharacterindex("Sumbhajee Aid1")].quest.Sumbhajee == "help_begin")
			{
				link.l1 = DLG_TEXT[1];
				link.l1.go = "bad_help_1";
			}
			if (characters[getcharacterindex("Sumbhajee Aid1")].quest.Sumbhajee == "governor")
			{
				link.l1 = DLG_TEXT[2];
		...
		case "bad_help_3":
			...
			link.l1 = DLG_TEXT[19];
			link.l1.go = "exit";
			characters[getcharacterindex("Sumbhajee Aid1")].quest.Sumbhajee = "bad_complete";
