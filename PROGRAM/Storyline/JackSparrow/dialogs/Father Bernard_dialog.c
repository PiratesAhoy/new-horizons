		...
		case "First time":
			...
			else
			{
				...
				if (CheckQuestAttribute("ANIMISTS", "to_prison_for_teacher_2"))
				{
					...
					GiveModel2Player("47_Ltsparrow", false);
					pchar.quest.ANIMISTS = "to_prison_for_teacher_3";

					pchar.quest.to_jail_with_eng_uni.win_condition.l1 = "location";
					pchar.quest.to_jail_with_eng_uni.win_condition.l1.location = "Greenford_prison";
					pchar.quest.to_jail_with_eng_uni.win_condition = "to_jail_with_eng_uni";
				}
				else
				{
