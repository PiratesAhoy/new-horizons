...
"?",
"I need some work. Do you know of any rich merchants who might be looking for an escort, or something in that line of business?",
...
"Not for the likes of you me buckie. You'd do better talking to that drunk over there.",
"Humph! I might just try that.. He'll probably be more polite than you at least.",
"What's the latest gossip in town? Any news from the other colonies?",
"What's the latest buzz?",
"Any news?",
"Did you hear any interesting stories which could be profitable for me?",
"Rumor goes the gouvenor ordered to increase the fleet, so the shipyard might be interested in some help.",
"Rumor goes the gouvenor wanted new uniforms, so the tailor might be interested in some help.",
"Rumor goes the gouvenor is going to fight the natives, so the smith might be interested in some help.",
"RESERVED FOR SHADY JOB",
"RESERVED FOR HIGH STATUS JOB",
"Thank you, I will check it out",
"Oh, never mind. That sounds like to much work.",
};
