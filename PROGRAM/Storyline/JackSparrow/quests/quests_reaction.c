...
//			AddQuestRecord("Contact", 13);
        ...
        //Tia_Dalma_swamp talk self tp to ship
	   ...
	   //Go to Elton Garfield on docks
		...
		//Need to go to a guard captain and try to get arrested by hitim him
		...
		case "escape_in_coffin_video_play":	
			PostVideoAndQuest("LegendJackSparrow\DMC_Coffin_escape", 25, "tp_deck_after_prison_deck_check");//check which ship deck player is using
		...
		case "escape_cannibals_video_play":	
			PostVideoAndQuest("LegendJackSparrow\DMC_cannibals_escape", 25, "tp_deck_after_cannibals");
			//SetCurrentTime(24.00, 0);
			DisableFastTravel(true);
			Locations[FindLocation(GetCharacterShipQDeck(PChar))].reload.l3.disable = 1;
			Locations[FindLocation(GetCharacterShipQDeck(PChar))].reload.l5.disable = 1;
		...
		case "Video_to_shipwreck2":	
			PostVideoAndQuest("LegendJackSparrow\DMC_dutchman_wreck", 25, "Video_to_shipwreck3");
			SetCurrentTime(24.00, 0);
			SetNextWeather("Heavy Rain");
		...
		case "Video_to_deck_from_shipw":	
			PostVideoAndQuest("LegendJackSparrow\DMC_dutchman_wreck_davey", 36, "Video_to_deck_from_shipw2");
			SetCurrentTime(24.00, 0);
			SetNextWeather("Heavy Rain");
		break;
