...
//Goldbug
	...
	case "examine_parchment_closely":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("examine_parchment_closely_done");
	break;

	case "examine_parchment_closely_again":
		PlaySound("OBJECTS\VOICES\DEAD\male\dead0.wav");
		Dialog.Text = DLG_TEXT[299];
		Link.l1 = DLG_TEXT[300];
		Link.l1.go = "examine_parchment_closely_again1";
	break;

	case "examine_parchment_closely_again1":
		PlaySound("VOICE\ENGLISH\blaze_hah.wav");
		Dialog.Text = DLG_TEXT[301];
		Link.l1 = DLG_TEXT[302];
		Link.l1.go = "examine_parchment_closely_again2";
	break;

	case "examine_parchment_closely_again2":
		PlaySound("OBJECTS\DUEL\man_attack6.wav");
		Dialog.Text = DLG_TEXT[303];
		Link.l1 = DLG_TEXT[304];
		Link.l1.go = "exit";
		AddDialogExitQuest("examine_parchment_closely_again2_done");
	break;
	...
	case "parchment_is_dirty":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("parchment_is_dirty_done");
	break;
	...
	case "Legrand_sleepy":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("Legrand_sleepy_done");
	break;
	...
	case "new_day":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("new_day_done");
	break;
	...
	case "no_wood_first":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("no_wood_first_done");
	break;

	case "Jup_to_moultrie":
		PlaySound("VOICE\ENGLISH\blaze_hah.wav");
		Dialog.Text = DLG_TEXT[293];
		Link.l1 = DLG_TEXT[294];
		Link.l1.go = "exit";
		AddDialogExitQuest("Jup_to_moultrie_done");
	break;
	...
	case "copy_full_code":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("copy_full_code_now");
	break;
	...
	case "Lut_G_cipher":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("copy_full_code_done1");
	break;
	...
	case "Dupin_6_items_found":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("kit_to_Dupin");
	break;
	...
	case "Poe_sentences":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("Poe_visit2_done");
	break;
	...
	case "Bessop_start":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("Bessop_start_done");
	break;
	...
	case "where_are_the_slaves":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("where_are_the_slaves_done");
	break;

	case "plantation_patrol":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("plantation_patrol_done");
	break;
	...
	case "bird_backside":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("bird_backside_done");
	break;
	...
	case "maroon_prep":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("maroon_prep1");
	break;
	...
	case "sketch_cliff_found":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("sketch_cliff_found_done");
	break;

	case "tree_zoom":
		Pchar.quest.skull_in_tree_found = "yes";

		PlaySound("VOICE\ENGLISH\blaze_what_was_that.wav");
		Dialog.Text = DLG_TEXT[329];
		Link.l1 = DLG_TEXT[330];
		Link.l1.go = "exit_spyglass_again";
		Link.l2 = DLG_TEXT[331];
		Link.l2.go = "exit_leave_devils_seat";
	break;
	...
	case "no_spyglass":
		...
		Link.l1.go = "exit_prepare_leave_devils_seat";
	break;

	case "Jup_to_Fort_Moultrie":
		PlaySound("VOICE\ENGLISH\blaze_mhm.wav");
		Dialog.Text = DLG_TEXT[341];
		Link.l1 = DLG_TEXT[342];
		Link.l1.go = "exit";
		AddDialogExitQuest("shopping_1J");
	break;
	...
	case "kungfu_new":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("kungfu_new_done");
	break;
	...
	case "use_boom_on_hatch":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("use_boom_on_hatch1");
	break;
	...
	case "use_gp_on_hatch1":
		...
		Link.l1.go = "use_gp_on_hatch2";
	break;

	case "use_gp_on_hatch2":
		PlaySound("VOICE\ENGLISH\blaze_mhm.wav");
		Dialog.Text = DLG_TEXT[347];
		Link.l1 = DLG_TEXT[348];
		Link.l1.go = "exit";
		AddDialogExitQuest("use_gp_on_hatch1");
	break;
	...
	case "Jup_tired_Poes_bedroom":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("Legrand_Pym_start");
	break;

	case "wood_steps_are_gone":
		Pchar.quest.ch_shore_resuse_ladder = "yes";
		PlaySound("OBJECTS\VOICES\DEAD\male\dead0.wav");
		Dialog.Text = DLG_TEXT[353];
		Link.l1 = DLG_TEXT[354];
		Link.l1.go = "exit";
		AddDialogExitQuest("wood_steps_are_gone_done");
	break;

	case "maroons_stop_us":
		LAi_SetActorType(Pchar);
		LAi_ActorTurnToLocator(Pchar, "goto", "m3");
		PlaySound("AMBIENT\JAIL\sigh.wav");
		PlaySound("AMBIENT\JAIL\sigh.wav");
		Dialog.Text = DLG_TEXT[355];
		Link.l1 = DLG_TEXT[356];
		Link.l1.go = "exit";
		AddDialogExitQuest("raft_talk");
	break;
	...
	case "follow_shore_to_raft":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("follow_shore_to_raft_done");
	break;
	...
	case "are_you_coming":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("are_you_coming_done");
	break;
	...
	case "Jup_climbs_tree":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("Jup_climbs_tree_done");
	break;
	...
	case "Jup_climbs_tree4B":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("Jup_climbs_tree4C");
	break;
	...
	case "Jup_climbs_tree5B":
		...
		Link.l1.go = "Jup_climbs_tree5C";
	break;

	case "Jup_climbs_tree5C":
		PlaySound("VOICE\ENGLISH\grandma_yell2.wav");
		Dialog.Text = DLG_TEXT[367];
		Link.l1 = DLG_TEXT[368];
		Link.l1.go = "exit";
		AddDialogExitQuest("Jup_climbs_tree6");
	break;
	...
	case "back_to_Charleston":
		...
		Link.l1.go = "back_to_Charleston1";
	break;

	case "back_to_Charleston1":
		PlaySound("VOICE\ENGLISH\blaze_mhm.wav");
		Dialog.Text = DLG_TEXT[371];
		Link.l1 = DLG_TEXT[372];
		Link.l1.go = "exit";
		AddDialogExitQuest("back_to_Charleston2");
	break;
	...
	case "no_maroons_left":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("no_maroons_left_done");
	break;
	...
	case "hideout_locked":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("kungfu_hint");
	break;

	case "throw_the_flour":
		PlaySound("VOICE\ENGLISH\Jupiter_1.wav");
		Dialog.Text = DLG_TEXT[377];
		Link.l1 = DLG_TEXT[378];
		Link.l1.go = "exit";
		AddDialogExitQuest("throw_the_flour_done");
	break;
	...
	case "need_machete":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("need_machete_done");
	break;
	...
	case "Jup_first_to_BH":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("Jup_first_to_BH_done");
	break;

	case "Legrand_first_to_plantation":
		PlaySound("VOICE\ENGLISH\blaze_mhm.wav");
		Dialog.Text = DLG_TEXT[383];
		Link.l1 = DLG_TEXT[384];
		Link.l1.go = "exit";
		AddDialogExitQuest("Legrand_first_to_plantation_done");
	break;
	...
	case "Poe_pistol":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("Poe_pistol_done");
	break;
	...
	case "Poe_tools":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("Poe_tools_done");
	break;
	...
	case "check_brothel_gate":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("check_other_side");
	break;
	...
	case "Poe_mission":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("Poe_mission_done");
	break;
	...
	case "Jup_why_stop":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("Jup_heavy_bug");
	break;
	...
	case "Jup_skull_rope":
		...
		Link.l1.go = "Jup_skull_rope1";
	break;

	case "Jup_skull_rope1":
		LAi_SetActorType(Pchar);
		LAi_ActorTurnToCharacter(Pchar, characterFromID("Jupiter"));
		...
		Link.l1.go = "Jup_skull_rope2";
	break;

	case "Jup_skull_rope2":
		LAi_SetActorType(Pchar);
		LAi_ActorTurnToCharacter(Pchar, characterFromID("Jupiter"));
		...
		Link.l1.go = "Jup_skull_rope3";
	break;

	case "Jup_skull_rope3":
		LAi_SetActorType(Pchar);
		LAi_ActorTurnToCharacter(Pchar, characterFromID("Jupiter"));
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("Jup_thinks_for_a_while");
	break;
	...
	case "Jup_lowers_rope":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("Jup_lowers_rope1");
	break;
	...
	case "Jup_lowers_rope3":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("Jup_lowers_rope4");
	break;
	...
	case "wrong_spot":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("wrong_spot_done");
	break;
	...
	case "wrong_spot1":
		...
		Link.l1 = DLG_TEXT[404];
		Link.l1.go = "exit";
		AddDialogExitQuest("wrong_spot2");
	break;
	...
	case "right_eye1":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("right_eye1_done");
	break;
	...
	case "Legrand_digs":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("Legrand_digs1");
	break;
	...
	case "sacks_from_Jupiter":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("sacks_from_Jupiter1");
	break;
	...
	case "3_first_sacks":
		...
		TakenItems(Pchar, "treasuresack", -2);

		Dialog.Text = DLG_TEXT[420];
		Link.l1 = DLG_TEXT[421];
		Link.l1.go = "exit";
		AddDialogExitQuest("3_first_sacks_taken");
	break;
	...
	case "Hero_my_cousin2":
		...
		Link.l1 = DLG_TEXT[404];
		Link.l1.go = "exit";
		AddDialogExitQuest("Hero_my_cousin3");
	break;
	...
	case "good_night":
		...
		Link.l1.go = "exit";
		AddDialogExitQuest("good_night1");
	break;
	...
	case "skeletons_talk2":
		...
		Link.l1 = DLG_TEXT[404];
		Link.l1.go = "skeletons_talk3";
	break;

	case "skeletons_talk3":
		...
		Link.l1 = DLG_TEXT[404];
		Link.l1.go = "exit";
		AddDialogExitQuest("skeletons_talk_end");
	break;

	case "Exit_spyglass_again":
		DialogExit();
		NextDiag.CurrentNode = NextDiag.TempNode;
		AddDialogExitQuest("tree_zoom_again");
	break;

	case "Exit_prepare_leave_devils_seat":
		DialogExit();
		NextDiag.CurrentNode = NextDiag.TempNode;
		AddDialogExitQuest("prepare_leave_devils_seat");
	break;

	case "Exit_leave_devils_seat":
		DialogExit();
		NextDiag.CurrentNode = NextDiag.TempNode;
		AddDialogExitQuest("leave_devils_seat");
	break;
