	...
	case "Where_Chico":
		Dialog.Text = DLG_TEXT[277];
			link.l1 = DLG_TEXT[278];
     		Link.l1.go = "exit";
		AddDialogExitQuest("go_outside_IMtavern");
	break;
	...
	case "berend_running":
		Dialog.Text = DLG_TEXT[279];
			link.l1 = DLG_TEXT[280];
     		Link.l1.go = "exit";
		AddDialogExitQuest("leaving_bonaire");
	break;
	...
	case "Back_Roxanne":
		Dialog.Text = DLG_TEXT[281];
			link.l1 = DLG_TEXT[282];
     		Link.l1.go = "exit";
		AddDialogExitQuest("fort_eleuthera");
	break;
	...
	case "Check_fort":
		Dialog.Text = DLG_TEXT[283];
			link.l1 = DLG_TEXT[284];
     		Link.l1.go = "exit";
		AddDialogExitQuest("fort_attacked3");
	break;

// El Diablo's coming back	
	
	case "Douwesen_Prison":
		Dialog.Text = DLG_TEXT[285];
			link.l1 = DLG_TEXT[286];
     		Link.l1.go = "exit";
		AddDialogExitQuest("douw_jailbis2");
	break;

// The aztec treasure	

	case "Jump_Bartolomeu":
		Dialog.Text = DLG_TEXT[287];
			link.l1 = DLG_TEXT[288];
     		Link.l1.go = "Jump_Bartolomeubis";
	break;

	case "Jump_Bartolomeubis":
