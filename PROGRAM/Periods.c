...
void InitPeriods()
{
	...
	period.Royal.France.Name = "Franзois Ier";
	...
	period.Islands.Guadeloupe.reload.l1.label = "Bahнa Grande";
...
//	period.Islands.Aruba.disable = true;
	...
	period.Towns.Charlestown.gov.middlename = "Pйrez";
	...
	period.Towns."Port au Prince".gov.name = "Nicolбs";
	...
	period.Towns."Grand Cayman".gov.middlename = "Garcнa";
	...
	period.Towns.Santiago.gov.middlename = "Menйndez";
	period.Towns.Santiago.gov.lastname = "de Avilйs";
...
//	period.Towns.Marigot.disable = true;							// not working entirely right yet
	...
	period.Towns.Eleuthera.gov.lastname = "Carreсo";
...
//	period.Towns.Douwesen.gov.lastname = "Rangel";					// PB: For Assassin storyline
	...
	period.Towns."Santo Domingo".gov.lastname = "Blбzquez";
	period.Towns."Grand Cayman".gov.name = "Francisco";
	period.Towns."Grand Cayman".gov.lastname = "Xelder";
	period.Towns.Havana.gov.name = "Pedro";
	period.Towns.Havana.gov.lastname = "Valdйs";
	period.Towns.Santiago.gov.name = "Gaspar";
	period.Towns.Santiago.gov.middlename = "Ruнz";
	period.Towns.Santiago.gov.lastname = "de Pereda";
	period.Towns."Pointe a Pitre".gov.name = "Josй";
	period.Towns."Pointe a Pitre".gov.middlename = "Fernandez";
	period.Towns."Pointe a Pitre".gov.lastname = "Cуrdoba";
	period.Towns.Eleuthera.Name = "Puerto la Cruz";
	period.Towns.Eleuthera.nation = SPAIN;
	...
	period.Towns."Santo Domingo".gov.middlename = "Pйrez";
	...
	period.Towns.Santiago.gov.middlename = "Martнnez";
	...
	period.Towns.Marigot.gov.middlename = "Martнnez";
	...
	period.Royal.England.Title = XI_ConvertString("His Royal Majesty");
	period.Royal.France.Name = "Louis XV le Bien-Aimй";
	period.Royal.France.Title = XI_ConvertString("His Most Christian Majesty");
	...
	period.Royal.Pirate.Title = XI_ConvertString("The chief");
	period.Royal.Holland.Title = XI_ConvertString("The Dutch Republic");
	period.Royal.Portugal.Name = "Josй I";
	period.Royal.Portugal.Title = XI_ConvertString("His Most Faithful Majesty");
	if (SWEDEN_ALLOWED)
	{
		period.Nations.Guest1 = "Sweden";
	...
	period.Towns."Isla Muelle".gov.name = "Juan";
	period.Towns."Isla Muelle".gov.middlename = "Josй";
	period.Towns."Isla Muelle".gov.lastname = "Colomo";
	period.Towns.Conceicao.gov.name = "Gabriel";
	period.Towns.Conceicao.gov.lastname = "de Lujбn";
	...
	period.Towns."Santo Domingo".gov.name = "Juan";
	period.Towns."Santo Domingo".gov.middlename = "Josй";
	...
	period.Towns."Santo Domingo".Name = "Santo Domingo";
	period.Towns."Santo Domingo".nation = SPAIN;
	period.Towns."Santo Domingo".gov.name = "Joaquнn";
	period.Towns."Santo Domingo".gov.middlename = "Garcнa";
	period.Towns."Santo Domingo".gov.lastname = "y Moreno";
	period.Towns.Havana.gov.name = "Josй";
	...
	period.Towns."Pointe a Pitre".gov.middlename = "Franзois";
	...
	period.Royal.England.Name = "George III";
	period.Royal.England.Title = XI_ConvertString("His Royal Majesty");
	period.Royal.France.Name = "Napolйon Bonaparte";
	period.Royal.France.Title = XI_ConvertString("L'Empereur");
	period.Royal.Spain.Name = "Joseph-Napolйon Bonaparte";
	...
	period.Towns.Havana.gov.name = "Juan";
	period.Towns.Havana.gov.middlename = "Ruнz";
	period.Towns.Havana.gov.lastname = "de Apodaca";
	period.Towns.Santiago.gov.name = "Josй";
