...
void Set_inDialog_Attributes()
{
	...
	AddressForms[GetAddressIndex(ADDR_CIVIL, SPAIN, 0)] = XI_ConvertString("Seсor");
	AddressForms[GetAddressIndex(ADDR_CIVIL, SPAIN, 1)] = XI_ConvertString("Seсorita");
	// pirate omitted.
...
// <-- KK
	...
	AddressForms[GetAddressIndex(ADDR_POLITE, SPAIN, 0)] = XI_ConvertString("Seсor");
	AddressForms[GetAddressIndex(ADDR_POLITE, SPAIN, 1)] = XI_ConvertString("Seсorita");
...
// KK -->
	if(pchr.sex == "woman")
	{
		nataddr[SPAIN] = XI_ConvertString("Seсorita");			//spell-checked by KAM
		...
		nataddr[SPAIN] = XI_ConvertString("Seсor");			//spell-checked by KAM
...
//		But only check to change to first name if you have a first name!
		if (GetMyName(chr) != "")
		{
			if(ourTitle == TranslateString("", "Dame") || ourTitle == TranslateString("", "Sir") ||
			   ...
			   ourTitle == TranslateString("", "Doсa") || ourTitle == TranslateString("", "Don") ||
