...
#define BUILDVERSION			"14 (1st January 2022)"		// this is not used in reinit.c anymore, so we can use a string now
#define IS_SGV					14.999						// must be a float - use small numbers to keep them sequential for all these updates --> 12.10 is smaller than 12.9!
