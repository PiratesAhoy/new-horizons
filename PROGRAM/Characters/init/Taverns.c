...
// <-- KK
	...
	ch.old.name = "Ramуn";
	ch.old.lastname = "Figueras";
	ch.name = TranslateString("", "Ramуn");
	ch.lastname = TranslateString("", "Figueras");
	ch.id		= "Ramуn Figueras";
	ch.model = "9S_Nav";
	ch.sex = "man";
	ch.sound_type = "male_citizen";
	GiveItem2Character(ch, "blade4");
...
// <-- KK
	...
	ch.old.name = "Miguel";
	ch.old.lastname = "Garcнa";
	ch.name = TranslateString("", "Miguel");
	ch.lastname = TranslateString("", "Garcнa");
	ch.id		= "Miguel Garcia";
	ch.model	= "Sailor15";
	ch.sex = "man";
	ch.sound_type = "male_citizen";
...
// GR --> Officiant 2
	ch.old.name = "Jimena";
	ch.old.lastname = "Lуpez";
	ch.name = TranslateString("", "Jimena");
	ch.lastname = TranslateString("", "Lуpez");
