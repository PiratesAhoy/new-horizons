...
// Day4 17
	...
	Weathers[n].Sea2.Attenuation = 0.4;
...
// Day4 18
	...
	Weathers[n].Sea2.Amp1 = 14.0; //амплитуда 1 волны
	Weathers[n].Sea2.AnimSpeed1 = 2.0; //скорость анимации
	Weathers[n].Sea2.Scale1 = 0.25; //размеры волны
	Weathers[n].Sea2.MoveSpeed1 = "1.0, 0.0, 4.5"; //скорость движения
