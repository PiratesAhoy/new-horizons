...
void Whr_DebugInfo(){
	...
	Traceandlog("Whr: Select lighting = " + Weathers.Lighting);
	Traceandlog("Fog Density: " + Weathers.Fog.Density);
	Traceandlog("Number of raindrops: " + Weathers.Rain.NumDrops );
	Traceandlog("Storm: " + Weathers.Storm );
