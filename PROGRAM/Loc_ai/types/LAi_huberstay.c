...
void LAi_SetStayHuberPoint1(aref chr, string group, string locator)
{
	if(chr.chr_ai.type == LAI_TYPE_HUBERSTAY)
	{
		chr.chr_ai.type.1_group = group;
		chr.chr_ai.type.1_locator = locator;
	}
}

void LAi_SetStayHuberPoint2(aref chr, string group, string locator)
{
	if(chr.chr_ai.type == LAI_TYPE_HUBERSTAY)
	{
		chr.chr_ai.type.2_group = group;
		chr.chr_ai.type.2_locator = locator;
	}
}

void LAi_SetStayHuberPoint3(aref chr, string group, string locator)
{
	if(chr.chr_ai.type == LAI_TYPE_HUBERSTAY)
	{
		chr.chr_ai.type.3_group = group;
		chr.chr_ai.type.3_locator = locator;
	}
}

void LAi_SetStayHuberPoint4(aref chr, string group, string locator)
{
	if(chr.chr_ai.type == LAI_TYPE_HUBERSTAY)
	{
		chr.chr_ai.type.4_group = group;
		chr.chr_ai.type.4_locator = locator;
	}
}

void LAi_SetStayHuberPoint5(aref chr, string group, string locator)
{
	if(chr.chr_ai.type == LAI_TYPE_HUBERSTAY)
	{
		chr.chr_ai.type.5_group = group;
		chr.chr_ai.type.5_locator = locator;
	}
}

void LAi_SetStayHuberPoint6(aref chr, string group, string locator)
{
	if(chr.chr_ai.type == LAI_TYPE_HUBERSTAY)
	{
		chr.chr_ai.type.6_group = group;
		chr.chr_ai.type.6_locator = locator;
	}
}