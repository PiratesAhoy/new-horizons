void ProcessDialogEvent()
{
	...
	Preprocessor_Add("addr", GetMyAddressForm(NPChar, PChar, ADDR_CIVIL, false, false)); // PB
	switch(Dialog.CurrentNode)
	{
		...
		case "node_2":
			...
			link.l1 = pcharrepphrase(DLG_TEXT[6] + GetMyName(NPChar) + DLG_TEXT[7], DLG_TEXT[8] + GetMyFullName(PChar) + DLG_TEXT[9]);
