...
void ProcessDialogEvent()
{
	...
	switch(iNation)
	{
		...
		//	Preprocessor_Add("captain", DLG_TEXT[44]);			// Doesn't work, displays "Capit�o" without converting "�"
			Preprocessor_Add("captain", TranslateString("","Capit�o"));	// But this does work!
