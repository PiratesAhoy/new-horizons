...
"I'm more interested in information at the moment. I wonder if your ship has ever run across a black warship with red sails.",
...
"Question? Ah, the black warship! Yes. I saw it as clearly as I see you now. If our holds hadn't been empty, I doubt I would be here to speak with you. Fortunately for my comrades and I, the ship's holds must have been full, and we were able to slip away. \nStrange name, as I recall. Not one I'd heard before. 'Mefisto.'",
"So, did the black ship give chase? And where did it go when it became clear it couldn't run your vessel down?",
