...
"A stone faced bastion (equipped with a cannon a formidable fortification; 10 planks,30 bricks, 10000 G, 15 hands).",
"A keep (fortress to safeguard your treasures; 30 planks, 100 bricks, 20000 G, 15 hands).",
"A house (for shelter and recreation, pays rent; 10 planks, 10 bricks, 4000 gold and 3 hands required).",
"A workshop (basis for jewel mine, foundry, shipyard, distillery ; 20 planks, 4000 gold and 3 hands required).",
"A farm (for shelter, produces wheat and coffee; 15 planks, 15 bricks, 5000 G, 10 hands).",
"A forest (produces planks and ebony; 0 planks, 2000 G, 5 hands).",
"A renaissance mansion (can be turned into your headquarter or a boudoir; 20 planks, 50 bricks, 20000 G, 5 hands).",
"A renaissance mansion (can be turned into your headquarter; 20 planks,50 bricks, 20000 G, 5 hands).",
"An observatory (can be turned into your headquarter; 10 planks, 30 bricks, 20000 G, 5 hands).",
"*** Blank slot for your creations, do not use now!! . ('yields' ; 10 planks, 10 bricks, 4000 G, 5 hands).",
...
"A mineshaft winding tower (turns a workshop into a jewelmine; 10 planks, 4000 G, 5 Crew).",
"A cannonball foundry (turns a workshop into a foundry; 10 planks, 4000 G, 5 Crew).",
"A rum distillery (turns a workshop into a distillery; 10 planks, 4000 G, 5 Crew).",
"A careenage (turns a workshop into shipyard; 10 planks, 4000 G, 5 Crew).",
"A cannon (to arm a fortification; 0 planks, 5000 G, 3 Crew).",
"A marketstall (turns house into tradepost, doubles rent; 5 planks, 5000 G, 3 hands).",
"Luxurious furniture (improves chance of successful woundtreatment in houses and farms; 5 planks, 1000 G, 1 Crew).",
"Madame Monique's Etablissement for Gentlemen's Entertainment (yields 'dividends', attracts sailors which can be crimped; 5 planks, 1000 G, 1 Crew).",
"An office (as your headquarter; to receive agents and hire officers; 5 planks, 1000 G, 1 Crew).",
"Umm, disregard all after 'Good morning', I have to go over the sketches once again.",
"*** Blank slot for your creations, do not use now!! (; planks, bricks, G, Crew).",
"Umm, #ssir#, a",
" requires ",
" planks and bricks respectively, ",
" Gold and ",
" men. But, as I said, we have only ",
" plank and brick units, ",
" G and ",
" hands...",
