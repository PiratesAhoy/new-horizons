...
//<-- RobC/A_S Smiths
		...
		case "town_tavern":
			...
			DeleteAttribute(&locations[FindLocation("Santo_Domingo_town")], "reload.l21.goto_disable"); // JRH: Unlock Fast Travel
		break;
		...
		case "town_shipyard":
			...
			Link.l3.go = "exit";
			DeleteAttribute(&locations[FindLocation("Santo_Domingo_town")], "reload.l18.goto_disable"); // JRH: Unlock Fast Travel
		break;
		...
		case "town_store":
			...
			Link.l3.go = "exit";
			DeleteAttribute(&locations[FindLocation("Santo_Domingo_town")], "reload.l5.goto_disable"); // JRH: Unlock Fast Travel
		break;
		...
		case "SantoDomingo":
			d.Text = DLG_TEXT[134] + DLG_TEXT[168] + GetTownSize("Santo Domingo") + DLG_TEXT[169];// NK
