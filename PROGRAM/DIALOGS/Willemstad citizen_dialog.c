...
//<-- RobC/A_S Smiths
		...
		case "town_tavern":
			...
			Link.l5 = DLG_TEXT[170];
			Link.l5.go = "town_tailorsshop";
			DeleteAttribute(&locations[FindLocation("Willemstad_town")], "reload.l4.goto_disable"); // JRH: Unlock Fast Travel
		break;
		...
		case "town_shipyard":
			...
			Link.l3.go = "exit";
			DeleteAttribute(&locations[FindLocation("Willemstad_town")], "reload.l8.goto_disable"); // JRH: Unlock Fast Travel
		break;
		...
		case "town_store":
			...
			Link.l3.go = "exit";
			DeleteAttribute(&locations[FindLocation("Willemstad_town")], "reload.l7.goto_disable"); // JRH: Unlock Fast Travel
		break;
		...
		case "town_tailorsshop":
			...
			Link.l6.go = "exit";
			DeleteAttribute(&locations[FindLocation("Willemstad_town")], "reload.l14.goto_disable"); // JRH: Unlock Fast Travel
		break;
		...
		case "Philipsburg":
			d.Text = DLG_TEXT[134] + DLG_TEXT[168] + GetTownSize("Willemstad") + DLG_TEXT[169]; // NK
