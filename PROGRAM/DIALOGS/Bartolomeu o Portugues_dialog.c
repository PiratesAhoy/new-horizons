...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			if (makeint(pchar.rank) > 4 && PChar.quest.Bartolomeu == "") 
			{
		...
		case "begin_8":
			...
			AddDialogExitQuest("Bart_start_search");
		break;
			...
			AddDialogExitQuest("Bart_search_refused");
		...
		break;
           ...
           case "begin_42": 
                      ...
                      NextDiag.CurrentNode = NextDiag.TempNode;
		      DialogExit();
                      AddDialogExitQuest("bartofficer");
