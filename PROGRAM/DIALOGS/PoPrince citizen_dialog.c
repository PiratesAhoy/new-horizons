...
//<-- RobC/A_S Smiths
		...
		case "town_tavern":
			...
			DeleteAttribute(&locations[FindLocation("PoPrince_town")], "reload.l5.goto_disable"); // BOP: Unlock Fast Travel
		break;
		...
		case "town_shipyard":
			...
			Link.l3.go = "exit";
			DeleteAttribute(&locations[FindLocation("PoPrince_town")], "reload.l15.goto_disable"); // BOP: Unlock Fast Travel
		break;
		...
		case "town_store":
			...
			Link.l3.go = "exit";
			DeleteAttribute(&locations[FindLocation("PoPrince_town")], "reload.l3.goto_disable"); // BOP: Unlock Fast Travel
		break;
		...
		case "PoPrince":
			d.Text = DLG_TEXT[134] + DLG_TEXT[168] + GetTownSize("Port au Prince") + DLG_TEXT[169]; // NK
