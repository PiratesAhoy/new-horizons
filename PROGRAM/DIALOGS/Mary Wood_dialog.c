//#include "DIALOGS\Mary Wood_dialog.h"
...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "begin_7":
			...
			link.l1 = DLG_TEXT[19];
			link.l1.go = "exit_2";
			//npchar.location="Tortuga_Town_01";
			npchar.location="Tortuga_Town_exit";			//JRH
			npchar.location.group = "goto";
			//npchar.location.locator = "goto1";
			npchar.location.locator = "citizen010";			//JRH
		...
		case "partage":
			...
			if (makeint(PChar.money) >= (makeint(Npchar.rank)*5000))
			{
				...
				npchar.location = "Tortuga_Tavern";
				npchar.location.group = "goto";
