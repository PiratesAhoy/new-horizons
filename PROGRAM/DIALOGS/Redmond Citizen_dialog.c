...
//<-- RobC/Alan_Smithee 'smiths
		...
		case "town_smithy":
			...
			Link.l3.go = "town_store";
			DeleteAttribute(&locations[Findlocation("Redmond_Town_01")], "reload.l14.goto_disable"); // SS: Unlock Fast Travel
		break;
//<-- RobC/A_S 'smiths
		...
		case "town_tavern":
			...
			DeleteAttribute(&locations[Findlocation("Redmond_Town_01")], "reload.l11.goto_disable"); // SS: Unlock Fast Travel			
		break;
		...
		case "town_shipyard":
			...
			Link.l3.go = "exit";
			DeleteAttribute(&locations[Findlocation("Redmond_Town_01")], "reload.l9.goto_disable"); // SS: Unlock Fast Travel
		break;
		...
		case "town_store":
			...
			Link.l3.go = "exit";
			DeleteAttribute(&locations[Findlocation("Redmond_Town_01")], "reload.l12.goto_disable"); // SS: Unlock Fast Travel
		break;
