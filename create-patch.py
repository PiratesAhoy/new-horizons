...
with ZipFile('patch.zip', 'w', compression=ZIP_LZMA) as z:
    ...
    z.write("installer/engine/crashpad_handler.exe", 'crashpad_handler.exe')
    z.write("installer/engine/engine.exe", 'engine.exe')
    z.write("installer/engine/engine.pdb", 'engine.pdb')
    z.write("installer/engine/fmod.dll", 'fmod.dll')
    z.write("installer/engine/mimalloc.dll", 'mimalloc.dll')
    z.write("installer/engine/mimalloc-redirect.dll", 'mimalloc-redirect.dll')
